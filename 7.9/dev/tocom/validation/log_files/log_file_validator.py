...
def setup_file(table):
    ...
    log_file_table.add_rule(tocom_fill_server_start_msg_is_logged, 'tocom_fill_server_start_msg_is_logged', cond='False')    
    log_file_table.add_rule(tocom_fill_server_stop_msg_is_logged, 'tocom_fill_server_stop_msg_is_logged', cond='False')
    
    
     
    log_file_table.override_rule('order_server_state_changed_msg_is_logged', 'True', 157204, note="Fixed in 7.16")
    ...
    log_file_table.optout_rule('order_server_contract_download_msg_is_logged', 'True', new_rule=None, note="Tocom does not use this rule")
    log_file_table.optout_rule('price_server_contract_download_msg_is_logged', 'True', new_rule=None, note="Tocom does not use this rule" )
